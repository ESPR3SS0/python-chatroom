...
class SingleGroupServer(self, name):
    '''
    ...
    def __init__(self, name):
        ...
        # List of connection objects to this group
        self.user_conns = []
    ...
    def session_loop(cmd: Command):
        ...
        match cmd:
            ...
            case ClientCommand.JOIN:
                ...
                if client_connection.username not in [client.name for client in self.client_connections]:
                    self.client_connection.append(client_connection)
                ...
                # Create the Queue payload that contains the packet type, contents, and targets
            ...
            case ClientCommand.USERS:
                ...
                ret_str = ", ".join([client.username for client in self.client_connections])
...
class MasterServer(self, host, port):
    '''
